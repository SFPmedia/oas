      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          <div className="ActivityIntroduction" id={"AI" + props.id}>
            ...
            {props.type ? (
              <Typography variant="body2" color="initial" gutterbottom="true">
                Type: <br /> {props.type}
              </Typography>
            ) : (
              <Typography variant="body2" color="initial" gutterbottom="true">
          ...
          <div className="ActivityGeneralInformation" id={"AGI" + props.id}>
            <Typography variant="h4" color="initial" gutterbottom="true">
              Practical Info
            </Typography>
            {props.open_hours ? (
            ...
            {props.website_link ? (
              <Typography variant="body2" color="initial" gutterbottom="true">
                Website: <br />
                <a href={props.website_link} rel="noreferrer" target="_blank">
